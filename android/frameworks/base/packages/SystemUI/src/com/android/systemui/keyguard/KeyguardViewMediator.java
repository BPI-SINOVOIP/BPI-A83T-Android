...
public class KeyguardViewMediator extends SystemUI {
    ...
    public void onScreenTurnedOff(int why) {
        synchronized (this) {
            ...
            if (mExitSecureCallback != null) {
                ...
                int time = mContext.getResources().getInteger(com.android.internal.R.integer.config_screenOffNotifyDelayTime);
                if (time > 0) {
                    mHandler.removeCallbacks(mDoKeyguardLockedRunnable);
                    mHandler.postDelayed(mDoKeyguardLockedRunnable, time);
                } else {
                    doKeyguardLocked(null);
                }
            }
    ...
    private Runnable mDoKeyguardLockedRunnable = new Runnable() {
        @Override
        public void run() {
            doKeyguardLocked(null);
        }
