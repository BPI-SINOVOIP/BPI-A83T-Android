    ...
    switch(eMessageId)
    {
        ...
        case PLAYER_VIDEO_RENDER_NOTIFY_PICTURE_PTS:
        {
            ...
            if(nTimeDiff >= -CONFIG_THREASHOLD_OF_PTS_DIFFERENCE_TO_JUDGE_PTS_jUMP && 
               nTimeDiff <= CONFIG_THREASHOLD_OF_PTS_DIFFERENCE_TO_JUDGE_PTS_jUMP)
            {
            ...
            else
            {
                ...
                logw("%d video frames not sync, force sync.", p->nUnsyncVideoFrameCnt);
            }
        ...
        case PLAYER_AUDIO_RENDER_NOTIFY_PTS_AND_CACHETIME:
        {
            ...
            if(nTimeDiff < -100000 || nTimeDiff > 100000)   //* difference is more than 100 ms.
            {
                ...
                logw("reset the timer to %lld, time difference is %lld", 
                    nCurAudioTime, nTimeDiff);
